...
namespace AVMVVMGUI.Models.CardEngine
{
    public class CardGame
    {
        ...
        public void SetDeck(Tree cardAttributes, CardCollection loc, string name)
        {
        ...
        public int PlayerMakeChoice(int numChoices, int playerIdx)
        {
            ...
            var choice = 0; //currentPlayer.Peek().memberList[playerIdx].decision.MakeAction(numChoices);
