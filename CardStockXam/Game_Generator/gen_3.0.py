...
def control_generate():
    ...
    for i in range(5):
        ...
        f = parseFile('/Users/anna/Desktop/cardstock/CardStockXam/Game_Generator/simple_recycle')
        for line in f:
            recycle.add_prod(str(line[0]), str(line[1]))
        base = open('/Users/anna/Desktop/cardstock/CardStockXam/Game_Generator/base').read()
        scoring = open('/Users/anna/Desktop/cardstock/CardStockXam/Game_Generator/scoring').read()
