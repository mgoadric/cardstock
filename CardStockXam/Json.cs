...
//		JsonDict,JsonString,JsonArray,JsonNum,JsonNull
//	};
//
//
...
//		int startIdx = 1;
//		if (input.Length == 0) {
//			this.jsonType = DataType.JsonNull;
//			return;
//		}
...
//			String[] res = input.Substring (1, input.Length - 2).Split (',');
...
//				}
//				int subCount = 0;
//				while (curIdx < input.Length && (input.Substring(curIdx,1) != closeType.ToString() || subCount != 0)){
